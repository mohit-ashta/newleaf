  ...
  return (
    <section className="py-20 bg-slate-200">
      <div className="container px-4 mx-auto">
        <div className="pb-10 mb-10 border-b border-gray-700 items-center text-black">
          <div className="grid grid-cols-2 items-center">
            <div>
              ...
              <p>
                old startup based out <br /> of Mohali, Punjab
              </p>
            </div>
            <div className="flex justify-end items-center gap-3">
              <div className=" text-black">Ready to get collaborate?</div>
              <div className="flex justify-center">
                <button className="bg-green px-4 py-3 rounded-lg gap-3 text-offWhite  hover:bg-white hover:text-black font-[400] transition-colors duration-300">
                  Get Started
                </button>
              </div>
            </div>
        ...
        <div className="flex flex-wrap -mx-4 mb-18">
          <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
            <div className="xs:max-w-xs">
              <h4 className="font-heading text-2xl font-semibold text-black mb-4">
                Subscribe to our newsletter
              </h4>
              <form action="">
                <label
                  className="block mb-1.5 text-sm font-semibold text-black"
                  for=""
                >
                  Email
                </label>
                <div className="xs:flex items-center">
                  <div className="relative mb-4 xs:mb-0 xs:mr-4">
                    ...
                    <input
                      className="w-full p-12 pr-4 py-4 text-sm text-black placeholder-gray-400 rounded-lg  border border-gray-700 outline-none"
                      type="email"
                      placeholder="pat@shuffle.dev"
                    />
                  </div>
                  <button
                    className="flex flex-shrink-0 ml-auto xs:ml-0 items-center justify-center w-12 h-12 text-orange-50 hover:text-white bg-green rounded-full transition duration-200"
                    type="submit"
                  >
                    <svg
                      width="24"
          ...
          <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
            <h5 className="text-lg font-semibold text-black mb-4">Services</h5>
            <ul>
              <li className="mb-4">
                <a
          ...
          <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
            <h5 className="text-lg font-semibold text-black mb-3">About</h5>
            <ul>
              <li className="mb-4">
                <a
                  className="inline-block text-black hover:text-black"
          ...
          <div className="w-full sm:w-1/3 lg:w-1/5 px-4">
            <h5 className="text-lg font-semibold text-black mb-4">Help</h5>
            <ul>
              <li className="mb-4">
                <a
                  className="inline-block text-black hover:text-black"
        ...
        <div className="sm:flex items-center justify-between">
          <div className="sm:flex mb-6 sm:mb-0 items-center">
            <a
              className="inline-block mr-6 sm:mr-12 text-black hover:text-black"
              href="#"
            >
              Terms & Conditions
            </a>
            <a className="inline-block text-black hover:text-black" href="#">
              Privacy Policy
            </a>
          </div>
          {/* <div className="flex items-center">
            ...
            >
              <img
                src="saturn-assets/images/footers/outline-facebook.svg"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                src="saturn-assets/images/footers/outline-socialmedia.svg"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                src="saturn-assets/images/footers/outline-linkedin.svg"
                alt=""
              />
            </a>
          </div> */}
